...
LongTruncOk=1'
  ...
  'recaptcha private key' => {
    'lastUpdated' => '1234738594',
    'message' => 'reCAPTCHA prive-sleutel'
  },
  ...
  'use recaptcha' => {
    'lastUpdated' => '1234738663',
    'message' => 'reCAPTCHA gebruiken?'
  },
  'use recaptcha description' => {
    'lastUpdated' => '1234738816',
    'message' => 'reCHAPTCHA is een kostenloze CAPTCHA-dienst, die de digitalizering van boeken ondersteunt. Deze benodigt een sleutelset, dat voor uw server gegenereerd wordt en bij  http://recaptcha.net/ aangevraagd kan worden.'
  },
  'user' => {
